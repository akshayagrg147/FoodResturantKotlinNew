...
class sharedpreferenceCommon @Inject constructor(mContext: Context) {
    ...
    fun setUserData(userData: String): Any {
        return mPrefs.edit().putString(AppConstant.USER_INFO, userData).apply()
    }

    fun getUserData(): String {
        return mPrefs.getString(AppConstant.USER_INFO, "").toString()
    }
